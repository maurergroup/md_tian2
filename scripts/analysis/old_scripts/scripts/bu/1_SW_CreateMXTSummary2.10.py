...
class Traj:
	def __init__(self, fname, ekin_p_i, ekin_l_i, epot_i, etotal_i,\
			...
			cl_appr, r_p_min, time_int, traj_id):
		self.fname    = fname
...
def write_summary():
	...
	outfile.write("# traj_id E_kin_p   E_kin_l        E_pot      E_total r_p(    x,        y,         z)     polar       azi   E_kin_p  E_kin_l       E_pot       E_total     r_p(x,       y,         z)       polar       azi     simtime turn_pnts   cl_appr   r_p_min   time_int\n")
